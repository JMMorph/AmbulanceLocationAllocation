    ...
    def execute_threaded_timeout(self, command):
        ...
        class ThreadedJob(threading.Thread):
            ...
            def run(self):
                ...
                comando = [f'{ruta_entorno_anaconda}/bin/python3'] + command
                ...
                self.logger.debug('job started')
                self.logger.debug('PATH=' + entorno['PATH'])
                self.logger.debug(comando)
                
                
                self.process = subprocess.Popen(comando,
...
if __name__=='__main__':
    ...
    executable = '/home/cic/Tesis/Source/Notebooks/optimize.py'
    fixed_params = ''
